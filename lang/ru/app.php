...
return [
    ...
    'auth' => [
        ...
        'or_continue_with' => 'Или продолжить с email',
        'forgot_password_title' => 'Забыли пароль',
        'forgot_password_message' => 'Введите ваш email и мы отправим вам ссылку для сброса пароля.',
        'send_reset_link' => 'Отправить ссылку',
        'sending' => 'Отправка...',
        'back_to_login' => 'Вернуться к входу',
        'reset_password' => 'Сбросить пароль',
        'reset_password_message' => 'Введите новый пароль ниже.',
        'new_password' => 'Новый пароль',
        'new_password_placeholder' => 'Введите новый пароль',
        'resetting' => 'Сброс...',
        'verify_email_title' => 'Подтвердите Email',
        'verify_email_message' => 'Спасибо за регистрацию! Перед началом работы, пожалуйста, подтвердите ваш email, нажав на ссылку в письме.',
        'verify_email_check_inbox' => 'Проверьте входящие и нажмите на ссылку для подтверждения.',
        ...
        'logout_and_try_again' => 'Выйти и попробовать другой email',
    ],
