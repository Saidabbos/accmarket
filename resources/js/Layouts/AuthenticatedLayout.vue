    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        <nav class="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-100 dark:border-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <button
                            ...
                            class="sm:hidden p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                        >
                ...
                <!-- Mobile Navigation -->
                <div v-if="showingNavigationDropdown" class="sm:hidden py-4 border-t border-gray-100 dark:border-gray-800">
                    <div class="space-y-1">
                        <Link
                            :href="route('shop.index')"
