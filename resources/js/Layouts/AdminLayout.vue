...
const navigation = [
    ...
    },
    {
        ...
        icon: 'languages',
        current: route().current('admin.languages.*')
    },
    {
        name: 'Translations',
        href: route('admin.translations.index'),
        icon: 'translations',
        current: route().current('admin.translations.*')
    },
];
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
                    <Link :href="route('admin.dashboard')" class="flex items-center space-x-3">
                        ...
                        <span class="text-lg font-semibold text-gray-900 dark:text-white">AccssIO</span>
                    </Link>
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    >
                        ...
                        <!-- Languages Icon -->
                        <svg v-if="item.icon === 'languages'" class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Translations Icon -->
                        <svg v-if="item.icon === 'translations'" class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
