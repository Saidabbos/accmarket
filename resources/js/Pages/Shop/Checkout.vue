        ...
        <div class="py-8">
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Review your order before proceeding to payment</p>
                </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                                <div
                                    ...
                                    :key="item.product.id"
                                    class="p-5 flex items-center space-x-4"
                                >
                                    ...
                                    <div class="text-right">
                                        <p class="font-semibold text-gray-900 dark:text-white">${{ item.subtotal.toFixed(2) }}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">${{ parseFloat(item.product.price).toFixed(2) }} each</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 rounded-xl p-5">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-medium text-indigo-900 dark:text-indigo-300">How it works</h4>
                                    <ul class="mt-2 text-sm text-indigo-800 dark:text-indigo-400 space-y-1">
                                        <li class="flex items-center">
                                            ...
                                            Click "Place Order" to reserve your items
                                        </li>
                                        <li class="flex items-center">
                                        ...
                                        <li class="flex items-center">
                                            ...
                                            Access your digital items immediately
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 sticky top-24">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="text-gray-900 dark:text-white font-medium">{{ cartItems.reduce((sum, item) => sum + item.quantity, 0) }}</span>
                                </div>
                            ...
                            <button
                                ...
                                class="mt-6 w-full flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors"
                            >
